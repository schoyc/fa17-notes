...
\begin{bytefield}[endianness=big]{16}
         \bitheader{0, 2, 3, 5, 6, 8, 9, 11, 12, 15} \\
         \bitbox{4}{opcode} & \bitbox{3}{\$rd} & \bitbox{3}{\$rs}
         & \bitbox{3}{\$rt} & \bitbox{3}{funct}\\
\end{bytefield}
...
\begin{bytefield}[endianness=big]{16}
         \bitheader{0, 2, 3, 5, 6, 8, 9, 11, 12, 15} \\
         \bitbox{4}{4} & \bitbox{3}{3} & \bitbox{3}{3}
         & \bitbox{3}{3} & \bitbox{3}{3}\\
\end{bytefield}
\end{center}
...
\begin{center}
\begin{bytefield}[endianness=big]{16}
         \bitheader{0, 9, 10, 11, 12, 15} \\
         \bitbox{4}{opcode} & \bitbox{2}{\$rd} & \bitbox{10}{immediate}\\
\end{bytefield}
...
\begin{bytefield}[endianness=big]{16}
         \bitheader{0, 9, 10, 11, 12, 15} \\
         \bitbox{4}{4} & \bitbox{2}{2} & \bitbox{10}{10}\\
\end{bytefield}
\end{center}
